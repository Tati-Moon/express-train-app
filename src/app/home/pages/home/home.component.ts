...
export class HomeComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        if (this.searchFormComponent) {
            ...
            this.searchFormComponent.searchCompleted.subscribe((searchStatus: boolean) => {
                console.log('Event received in HomeComponent:', searchStatus);
                this.onStartSearchChange(searchStatus);
            });
        }
    }

    onStartSearchChange(searchStatus: boolean) {
        this.startSearch = searchStatus;
        console.log('Search status changed:', searchStatus);
    }
